...
var validate = new function () {
  ...
  this.domain = function (domain) {
    return typeof domain === 'string' && (domain === 'is-a.co')
  }
...
function addSubDomain(data) {
  ...
  var subdomainsBlacklist = [
    ...
    "subscribe", "support", "sync", "system", "systems", "tag", "tags", "team", "teams", "tech", "terminal",
    "this", "that", "tip", "tool", "tools", "topic", "topics", "translate", "trend", "trends", "trick", "tricks",
    "trust", "trusted", "tutorial", "tweak", "tweaks", "type", "types", "unit", "units", "united",
